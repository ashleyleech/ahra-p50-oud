...
load("/Volumes/p50_oud/Ahra/moud_cohort_202601.Rdata")
```
...
## Box 1: Starting cohort 

```{r box1-count}
  cat("Pregnancies meeting enrollment criteria (BTrack==90):",
      formatC(n_step1, format = "d", big.mark = ","))
```
